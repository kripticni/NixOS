...
static const char *fonts[]          = { "Fira Code:size=12", "font-awesome:size=12", "noto-fonts-emoji:size=12", "siji-ttf:size=12", "ttf-unifont:size=12", "ttf-joypixels:size=12", "RobotoMono Nerd Font:size=12", "NotoEmoji:size=12", "Noto Sans CJK JP:size=12" };
